...
//
  ...
  extension NSImage {
    ...
    func getColors(quality: ScaleQuality = .high) -> Colors? {
    ...
    func getColors(quality: ScaleQuality = .high, _ completion: @escaping (Colors?) -> Void) {
    ...
    func colors(quality: ScaleQuality = .high) async -> Colors? {
  ...
  extension NSImage {
    func _resizedCGImage(size: CGSize) -> CGImage? {
